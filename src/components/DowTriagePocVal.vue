<template>
  <div>
    <h1>DOW Triage POC (with validation)</h1>
    <div class="container">

      <div id="q1-row" class="question-row">
        <div class="question">
          <label for="q1">Are you building over a pitch fiber pipe, asbestos, cement, brick?</label>
          <span class="validation" v-if="shouldValidate && vq1 === null">Required</span>
          </div>
        <div class="answer">
          <input type="radio" name="q1" v-bind:value="true" id="q1-yes" v-model="vq1" v-on:click="shouldValidate=false">
          <label for="yes">Yes</label>
          <input type="radio" name="q1" v-bind:value="false" id="q1-no"  v-model="vq1" v-on:click="shouldValidate=false" >
      ...
      <transition name="fade">
        <div id="q2-row" class="question-row" v-if="vq1===false">
          ...
          <span class="validation" v-if="shouldValidate && vq2 === null">Required</span>
            </div>
          <div class="answer">
      ...
      <transition name="fade">
        <div id="q3-row" class="question-row" v-if="showQ3">
          ...
          <span class="validation" v-if="shouldValidate && vq3 === null">Required</span>
          </div>
          <div class="answer">
            <input type="radio" name="q3" v-bind:value="true" id="q3-yes" v-model="vq3" v-on:click="shouldValidate=false">
            <label for="yes">Yes</label>
            <input type="radio" name="q3" v-bind:value="false" id="q3-no"  v-model="vq3" v-on:click="shouldValidate=false">
            <label for="no">No</label>
          </div>
        </div>
      </transition>
      ...
      <transition name="fade">
        <div id="q4-row" class="question-row" v-if="showQ4">
          ...
          <span class="validation" v-if="shouldValidate && vq4 === null">Required</span>
            </div>
          <div class="answer">
            <input type="radio" name="q4" v-bind:value="true" id="q4-yes" v-model="vq4" v-on:click="shouldValidate=false">
            <label for="yes">Yes</label>
            <input type="radio" name="q4" v-bind:value="false" id="q4-no"  v-model="vq4" v-on:click="shouldValidate=false">
            <label for="no">No</label>
          </div>
        </div>
      </transition>
      ...
      <transition name="fade">
        <div id="q5-row" class="question-row" v-if="showQ5">
          ...
          <span class="validation" v-if="shouldValidate && vq5 === null">Required</span>
            </div>
          <div class="answer">
            <input type="radio" name="q5" v-bind:value="true" id="q5-yes" v-model="vq5" v-on:click="shouldValidate=false">
            <label for="yes">Yes</label>
            <input type="radio" name="q5" v-bind:value="false" id="q5-no"  v-model="vq5" v-on:click="shouldValidate=false">
            <label for="no">No</label>
          </div>
        </div>
      </transition>
      ...
      <div class="submit-buttons">
        ...
        <div class="button__next">
          <input type="button" value="Next"  class="button--next primary-button submit-buttons__right-button" v-on:click="handleNext()" />
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  watch: {
      ...
      vq4() {
        ...
        this.showQ5 = (this.vq4 !== null) ? !this.vq4 : null;
      },
      vq5() {
        this.stopApplication = false;
